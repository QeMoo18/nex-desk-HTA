<div class="pageheader hidden-xs">
    <h3><i class="fa fa-user"></i> PPM Activity</h3>
...
<script type="text/javascript">
    $(document).ready(function (){
        ...
        if("<?= $this->session->userdata('id_activity')?>"==''){
            ...
            window.location.href="<?= base_url()?>Form_PPM/List_activity_network";
        } 
		            ...
		            <tbody>
		               <tr>
                          <td>
                                ...
                                <a href="<?= base_url()?>Form_PPM/PPM_Form_Network?hostname=<?= $hostname?>&ppm_id=<?= $ppm_id?>&type=<?= $type?>&filter=Search"><i class="fa fa-edit"></i></a>

		...
		<div class="col-md-7">
			...
			<div class="box box-success">
	          <div class="box-header with-border">
	            <h3 class="box-title"> <b>Edit Hardware Type</b> </h3>
	          </div>
	          <div class="box-body">
...
<script type="text/javascript">
	...
	function details()
	{
        ...
        $.ajax({
                    url: '<?= base_url() ?>Admin/A_cmdb_hardwareType_details',
                    type: 'POST',
                    dataType: 'json',
                    data: data,
                    beforeSend: function() {
                    ...
                    success: function(response){
						...
						var hwtype_name = $("#hwtype_name").val(response.hardware_type);
                    }
              });
	}
	...
	function submit()
	{
			...
			$.ajax({
			        url: "<?= base_url() ?>Admin/A_cmdb_hardwareType_update",
			        type: "POST",
			        dataType: "html",
			        data: data,
			        beforeSend: function() {
			        ...
			        success: function(response){
			        	//alert('Success update hardware type');
			        	//location.reload();

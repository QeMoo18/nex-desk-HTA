...
<div class="panel">
    ...
    <div class="panel-body">
            ...
            <div class="col-md-12" style="padding-left: 0px;">
                <a href="<?= base_url()?>Form_PPM/data_network/<?= $this->uri->segment(3)?>"><span class="box2 red2"><i class="fa fa-angle-double-left"></i> Asset </span></a>  
            ...
            <div class="" style="padding-top: 30px; float: right; padding-bottom: 30px;padding-right: 30px;">
                <!-- <div class="col-md-6" style="padding-bottom: 10px;">
                    <a href="<?= base_url()?>Form_PPM/data_network/<?= $this->uri->segment(3)?>">
...
<script type='text/javascript'>
   $(document).ready(function(){
    ...
    function loadPagination(pagno){
        ...
        $.ajax({
         data : data,
         url: '<?=base_url()?>Form_PPM/work_network_list_data/'+pagno,
         type: 'post',
         dataType: 'json',
         success: function(response){

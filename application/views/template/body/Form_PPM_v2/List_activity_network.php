<div class="pageheader hidden-xs">
    <h3><i class="fa fa-user"></i> Asset / Preventive Maintenance / Network</h3>
...
<div class="panel">
    ...
    <div class="panel-heading ui-sortable-handle">
        <h3 class="panel-title">Network PPM Activity</h3>
    </div>
    <!--Panel body-->
...
<form action="<?= base_url()?>Form_PPM/data_network/1" method="post" id="btn_submit">

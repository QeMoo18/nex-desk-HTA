    ...
    <div class="panel-body">
    		...
    		<div class="row">
        		...
        		<div class="col-md-2" style="padding-bottom: 10px; padding-right: 0px; ">
        			<a href="<?= base_url()?>Form_PPM/List_activity_workstation_add	"><button class="btn btn-primary btn-block">Add PPM Activity</button></a>
        		</div>
    		...
    		<div class="table table-responsive">
		         <table class="table">
		            ...
		            <tbody>
		               <tr>
                          <td><a href="<?= base_url()?>Form_PPM/List_activity_workstation_update/<?= $data["id"]?>"><i class="fa fa-edit"></i></a></td>
		                  <td> 

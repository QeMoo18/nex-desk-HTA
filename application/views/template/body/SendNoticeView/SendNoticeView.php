    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-2">
                ...
                <a href="<?=base_url()?>Admin/SendNotice"><button class="btn btn-success btn-block"> + Send Notice</button></a>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var t = $("#mytable2").dataTable({
            ...
            ajax: {
                      data: send_param,
                      "url": "<?=base_url()?>Admin/Dtable_SendNotice_ViewList", 
                      "type": "POST"
                  },
            columns: [
                // {
    ...
    {
        window.location.href="<?= base_url()?>Admin/Details_notice/"+id;
    }

				...
				<div class="box box-success">
		          ...
		          <div class="box-body">
							...
							<div class="form-group">
			                  ...
			                  <input type='text' class='form-control' name='Title' id="title" value="<?= send_notice_view_title_schedule($this->uri->segment(3))?>"> 
			                </div>
							
			                <div class="form-group">
              					<label for="exampleInputEmail1">Note</label>
              					<br>
              					<?= send_notice_view_note_schedule($this->uri->segment(3))?>
			                </div>
			                ...
			                <div class="form-group">
			                  ...
			                  <input type='text' class='form-control datepicker' name='Date' id="date_schedule" value="<?= send_notice_view_date__schedule($this->uri->segment(3))?>"> 
			                </div>

    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-2">
                ...
                <a href="<?=base_url()?>Admin/SendNotice_Schedule"><button class="btn btn-success btn-block"> + Send Notice</button></a>
                </div>
            </div>
            ...
            <div class="col-md-7">
                ...
                <div class="box box-success">
                  <div class="box-header with-border">
                    <h3 class="box-title"> <b>View Notice</b></h3>
                  </div>
                  <div class="box-body">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var t = $("#mytable2").dataTable({
            ...
            ajax: {
                      data: send_param,
                      "url": "<?=base_url()?>Admin/Dtable_SendNotice_ViewList_Schedule", 
                      "type": "POST"
                  },
            columns: [
                // {
    ...
    function delUser(id)
    {
        ...
        $("#confirm").click(function (){
            var other_id = id;
            var nama_table = 'net_send_reschedule';
            var where_column = 'id';
    ...
    {
        window.location.href="<?= base_url()?>Admin/Details_notice_Schedule/"+id;
    }

	...
	<section class="content">
		...
		<div class="row">
			...
			<div class="col-md-2">
				...
				<a href="<?=base_url()?>Admin/Role_Add"><button class="btn btn-success btn-block"> + Role Group</button></a>
				</div>
			</div>
			...
			<div class="col-md-10">
				...
				<div class="box box-success">
		          <div class="box-header with-border">
		            <label class="box-title"> <b>View Role</b></label>
		          </div>
		          <div class="box-body">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        var t = $("#mytable2").dataTable({
            ...
            ajax: {
                      data: send_param,
                      "url": "<?=base_url()?>Admin/Dtable_Role_ViewList", 
                      "type": "POST"
                  },
            columns: [
                // {
                ...
                {"data": "changed"},
                {"data": "created"},
                {"data": "id_role",render:editIcon},
                {"data": "id_role",render:delIcon}
	...
	function editUser(id)
	{
		...
		window.location.href = base_url+'Admin/Role_EditDetails/'+id;
	}

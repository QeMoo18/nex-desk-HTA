...
<div class="content-wrapper">
	<section class="content">
		<h5><i class="fa fa-angle-double-right" aria-hidden="true"></i> Customer Management</h5>
		<div class="row">
			<div class="col-md-2"> 
		          ...
		          <div class="box-body">
		          		<div class="row">
								...
								<div class="form-group col-md-3" style="display: none">
				                  ...
				                  <input type='text' class='form-control' name='C_CustName' id='C_CustName' value="-">
	...
	function submit()
	{
		...
		if((C_CustName=='')||(custID=='')||(C_valid=='')){
			...
			{   
	            ...
	            $.ajax({
	                    url: '<?= base_url() ?>Admin/CM_Customer_form',
	                    type: 'POST',
	                    dataType: 'html',
	                    data: data,
	                    beforeSend: function() {

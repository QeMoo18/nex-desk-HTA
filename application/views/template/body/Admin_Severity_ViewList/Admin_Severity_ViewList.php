	...
	<section class="content">
		...
		<div class="row">
			<div class="col-md-2">
				...
				<a href="<?=base_url()?>Admin/Admin_Severity_Add"><button class="btn btn-success btn-block"> + Add Service Type</button></a>
				</div>
			</div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        var t = $("#mytable2").dataTable({
            ...
            ajax: {
                      data: send_param,
                      "url": "<?=base_url()?>Admin/Dtable_Severity_ViewList", 
                      "type": "POST"
                  },
            columns: [
                // {
	...
	function editUser(id)
	{
		...
		window.location.href = base_url+'Admin/Admin_Severity_editList/'+id;
	}

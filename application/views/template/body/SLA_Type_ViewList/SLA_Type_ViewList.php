	...
	<section class="content">
		...
		<div class="row">
			<div class="col-md-2">
				...
				<a href="<?=base_url()?>Admin/SLA_AddType"><button class="btn btn-success btn-block"> + Add SLA Type</button></a>
				</div>
			</div>
			<div class="col-md-7">
				...
				<div class="box box-success">
		          <div class="box-header with-border">
		            <h3 class="box-title"> <b>View SLA Type</b></h3>
		          </div>
		          <div class="box-body">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        var t = $("#mytable2").dataTable({
            ...
            ajax: {
                      data: send_param,
                      "url": "<?=base_url()?>Admin/Dtable_SLA_Type_ViewList", 
                      "type": "POST"
                  },
            columns: [
                // {
                ...
                {"data": "changed"},
                {"data": "created"},
                {"data": "type_id",render:editIcon},
                {"data": "type_id",render:delIcon}
	...
	function editUser(id)
	{
		...
		window.location.href = base_url+'Admin/SLA_Type_EditDetails/'+id;
	}
    ...
    function delUser(id)
    {
        ...
        $("#confirm").click(function (){
            var other_id = id;
            var nama_table = 'sla_type';
            var where_column = 'type_id';

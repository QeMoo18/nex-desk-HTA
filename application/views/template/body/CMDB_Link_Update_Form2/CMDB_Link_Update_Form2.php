			...
			<div class="col-md-12">
				...
				<div class="box box-success">
		          <div class="box-header with-border">
		            <h3 class="box-title"> <b>Asset Link Update</b> </h3>
		          </div>
		          <div class="box-body">
		          	...
		          	<!-- Start First -->
		          		<input type="hidden" name="auto_id" id="auto_id" value="<?= $this->uri->segment('3')?>">
		          		<div id="first_div" class="row">
			                ...
			                <script type="text/javascript">
			                	$(document).ready(function (){
			                		...
			                		var data = 	{
										...
										$.ajax({
								                    url: "<?= base_url() ?>CMDB/cmdb_get_custID",
								                    type: "POST",
								                    dataType: "html",
								                    data: data,
								                    beforeSend: function() {
					...
					<!-- SECOND -->
						<div id="second_div" style="display: none">
							...
							<div class="row">
					            ...
					            <div class="form-group col-md-2">
					            	<button type="submit" class="btn btn-primary btn-block" onclick="submit();" id="btn_up">Update</button>
					            </div>

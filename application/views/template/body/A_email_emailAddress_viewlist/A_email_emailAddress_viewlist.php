	...
	<section class="content">
		...
		<div class="row">
			<div class="col-md-2">
				...
				<a href="<?=base_url()?>Admin/A_email_emailAddress_add"><button class="btn btn-success btn-block"> + Add Email </button></a>
				</div>
			</div>
			<div class="col-md-8">
				...
				<div class="box box-success">
		          <div class="box-header with-border">
		            <h3 class="box-title"> <b>View List Email Address</b></h3>
		          </div>
		          <div class="box-body">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        var t = $("#mytable2").dataTable({
            ...
            ajax: {
                      data: send_param,
                      "url": "<?=base_url()?>Admin/Dtable_email_emailAddress_viewlist", 
                      "type": "POST"
                  },
            columns: [
                // {
                //     "data": "id_group",
                //     "orderable": false
                // }, id,email,display_name,queue,validity,comment,changed,created,default_id
                {"data": "email"},
                {"data": "display_name"},
                {"data": "queue"},
                {"data": "comment"},
	...
	function editUser(id)
	{
		...
		window.location.href = base_url+'Admin/A_email_emailAddress_EditDetails/'+id;
	}

	...
	<section class="content">
		...
		<div class="row">
			<div class="col-md-2">
				...
				<a href="<?=base_url()?>Admin/Criticality_AddType"><button class="btn btn-success btn-block"> + Add Criticality Type</button></a>
				</div>
			</div>
			<div class="col-md-7">
				...
				<div class="box box-success">
		          <div class="box-header with-border">
		            <h3 class="box-title"> <b>View Criticality Type</b></h3>
		          </div>
		          <div class="box-body">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        var t = $("#mytable2").dataTable({
            ...
            ajax: {
                      data: send_param,
                      "url": "<?=base_url()?>Admin/Dtable_Criticality_ViewList", 
                      "type": "POST"
                  },
            columns: [
                // {
	...
	function editUser(id)
	{
		...
		window.location.href = base_url+'Admin/Criticality_EditDetails/'+id;
	}
    ...
    function delUser(id)
    {
        ...
        $("#confirm").click(function (){
            var other_id = id;
            var nama_table = 'criticality_type';

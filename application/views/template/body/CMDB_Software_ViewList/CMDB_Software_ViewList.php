	...
	<section class="content">
		...
		<div class="row">
			...
			<div class="col-md-2">
				...
				<a href="<?=base_url()?>CMDB/CMDB_Software_Add"><button class="btn btn-success btn-block"> + Add Software</button></a>
				</div>
			</div>
...
<script type="text/javascript">
	...
	function search_network(){
        ...
        var t = $("#mytable2").dataTable({
            ...
            ajax: {
                      data: send_param,
                      "url": "<?=base_url()?>CMDB/Dtable_CMDB_Software_ViewList", 
                      "type": "POST"
                  },
            columns: [
	...
	function edit(id)
	{
		...
		window.location.href = base_url+'CMDB/CMDB_Software_EditDetails/'+id;
	}

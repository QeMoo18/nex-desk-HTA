<div class="pageheader hidden-xs">
    <h3><i class="fa fa-list"></i> List Ticket : Queu View </h3>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-success">
                      <div class="box-header with-border">
                        <h3 class="box-title"> <b><i class="fa fa-list-alt" aria-hidden="true"></i> List Ticket By Queu </b></h3>
                      ...
                      <div class="box-body" style="padding-bottom: 30px;">
                        ...
                        <div class="form-group">
                                    <select class='form-control' name='thp_queue' id='tp_queue' style="width: 250px;">
                                        <option value=''>-- Please Select Queue --</option>
                                            <?= lookup_queue(); ?>
                                          </select>
                       ...
                       <!--  <div class="col-md-12">
                            <div class="col-md-4"> 
                                <div class="form-group">
                                    <select class='form-control' name='thp_queue' id='tp_queue' >
                                        <option value=''>-- Please Select Queue --</option>
                                            <?= lookup_queue(); ?>
                                          </select>
                                        <span id="alert_tp_queue"></span> 
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var t = $("#mytable2").dataTable({
            ...
            ajax: {
                      data: send_param,
                      "url": "<?=base_url()?>Ticket/Dtable_Ticket_Queu", 
                      "type": "POST",
                      deferRender: true
                  },
            columns: [
    ...
    $("#tp_queue").change(function (){
        var tp_queue = $("#tp_queue").val();
        //alert(tp_queue);
        search_by_queu(tp_queue);
    });


    function search_by_queu(id)
    {
        $.fn.dataTableExt.oApi.fnPagingInfo = function(oSettings)
        {
            return {

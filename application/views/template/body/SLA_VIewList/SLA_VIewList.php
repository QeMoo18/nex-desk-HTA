	...
	<section class="content">
		...
		<div class="row">
			...
			<div class="col-md-2">
				...
				<a href="<?=base_url()?>Admin/SLA_AddService"><button class="btn btn-success btn-block"> + Add SLA</button></a>
				</div>
			</div>
			...
			<div class="col-md-10">
				...
				<div class="box box-success">
		          <div class="box-header with-border">
		            <h3 class="box-title"> <b>View List</b></h3>
		          </div>
		          <div class="box-body">
...
<script type="text/javascript">
	...
	function editUser(id)
	{
		...
		window.location.href = base_url+'Admin/SLA_EditDetails/'+id;
	}

	...
	<section class="content">
		...
		<div class="row">
			<div class="col-md-2">
				...
				<a href="<?=base_url()?>Admin/TS_FaultCategoryPortion_add"><button class="btn btn-success btn-block"> + Fault Category Portion </button></a>
				</div>
			</div>
			<div class="col-md-7">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        var t = $("#mytable2").dataTable({
            ...
            ajax: {
                      data: send_param,
                      "url": "<?=base_url()?>Admin/Dtable_FaultCategoryPortion_viewlist", 
                      "type": "POST"
                  },
            columns: [
                // {
	...
	function editUser(id)
	{
		...
		window.location.href = base_url+'Admin/TS_FaultCategoryPortion_EditDetails/'+id;
	}
    ...
    function delUser(id)
    {
        ...
        $("#confirm").click(function (){
            var other_id = id;
            var nama_table = ' faulty_category_portion';

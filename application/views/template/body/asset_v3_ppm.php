...
<div class="panel">
    ...
    <div class="panel-heading ui-sortable-handle">
        <h3 class="panel-title">Preventive Maintenance</h3>
    </div>
    <!--Panel body-->
		      ...
		      <div class="panel panel-default" style="border: transparent;">
		        <div class="panel-heading">
		          <h4 class="panel-title">
		            <a data-toggle="collapse" href="#test_v3"><i class="fa fa-share-alt"></i> Workstation </a>
		          </h4>
		        </div>
		...
		<div class="col-md-3">
		    <div class="panel-group">
		      <div class="panel panel-default" style="border: transparent;">
		        <div class="panel-heading">
		          <h4 class="panel-title">
		            <a data-toggle="collapse" href="#test_v3"><i class="fa fa-share-alt"></i> Server </a>
		          </h4>
		        </div>
		        <div id="test_v3" class="panel-collapse collapse in" style="background-color:#5d95bdbf;">
		...
		<div class="col-md-3">
		    <div class="panel-group">
		      <div class="panel panel-default" style="border: transparent;">
		        <div class="panel-heading">
		          <h4 class="panel-title">
		            <a data-toggle="collapse" href="#test_v3"><i class="fa fa-share-alt"></i> Network </a>
		          </h4>
		        </div>
		        <div id="test_v3" class="panel-collapse collapse in" style="background-color:#5d95bdbf;">

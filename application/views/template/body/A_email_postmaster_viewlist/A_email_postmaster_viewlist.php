	...
	<section class="content">
		...
		<div class="row">
			<div class="col-md-2">
				...
				<a href="<?=base_url()?>Admin/A_email_postmaster_add"><button class="btn btn-success btn-block"> + Add mail account </button></a>
				</div>
			</div>
			<div class="col-md-7">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        var t = $("#mytable2").dataTable({
            ...
            ajax: {
                      data: send_param,
                      "url": "<?=base_url()?>Admin/Dtable_email_postmaster_viewlist", 
                      "type": "POST"
                  },
            columns: [
                // {
	...
	function editUser(id)
	{
		...
		window.location.href = base_url+'Admin/A_email_postmaster_EditDetails/'+id;
	}

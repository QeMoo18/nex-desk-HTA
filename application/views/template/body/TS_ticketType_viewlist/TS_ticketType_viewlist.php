	...
	<section class="content">
		...
		<div class="row">
			<div class="col-md-2">
				...
				<a href="<?=base_url()?>Admin/TS_ticketType_add"><button class="btn btn-success btn-block"> + Add Ticket Type </button></a>
				</div>
			</div>
			<div class="col-md-10">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        var t = $("#mytable2").dataTable({
            ...
            ajax: {
                      data: send_param,
                      "url": "<?=base_url()?>Admin/Dtable_ticketType_viewlist", 
                      "type": "POST"
                  },
            columns: [
                // {
	...
	function editUser(id)
	{
		...
		window.location.href = base_url+'Admin/TS_ticketType_EditDetails/'+id;
	}

        ...
        <div class="row">
            <div class="col-md-2"> 
                <div class="form-group">
                    <a href="<?= base_url()?>admin/A_cmdb_software_add"> 
                        <button class="btn btn-danger btn-block"> + Add Software</button>
                    </a>
                </div>
            </div>
            <div class="col-md-10">
				...
				<div class="box box-success">
		          <div class="box-header with-border">
		            <h3 class="box-title"> <b>View Software</b></h3>
		          </div>
		          <div class="box-body">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        var t = $("#mytable2").dataTable({
            ...
            ajax: {
                      data: send_param,
                      "url": "<?=base_url()?>Admin/Dtable_CMDB_Software_ViewList", //CREATE FUNCTION DEKAT CONTROLLER 
                      "type": "POST"
                  },
            columns: [
	...
	function editUser(id)
	{
		...
		window.location.href = base_url+'Admin/A_cmdb_software_EditDetails/'+id;
	}
    ...
    function delIcon(id)
    {
        ...
        $("#confirm").click(function (){
                ...
                $.ajax({
                            url: '<?= base_url() ?>Admin/Delete_CMDB_Software_ViewList', //create nama function delete controller
                            type: 'POST',
                            dataType: 'html',
                            data: data,
                            beforeSend: function() {

	...
	<section class="content">
		...
		<div class="row">
			<div class="col-md-2">
				...
				<a href="<?=base_url()?>Admin/A_cmdb_networkType_add"><button class="btn btn-success btn-block"> + Add Network Type</button></a>
				</div>
			</div>
			<div class="col-md-7">
				...
				<div class="box box-success">
		          <div class="box-header with-border">
		            <h3 class="box-title"> <b>View Network Type</b></h3>
		          </div>
		          <div class="box-body">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        var t = $("#mytable2").dataTable({
            ...
            ajax: {
                      data: send_param,
                      "url": "<?=base_url()?>Admin/Dtable_cmdb_networkType_ViewList", 
                      "type": "POST"
                  },
            columns: [
                // {
	...
	function editUser(id)
	{
		...
		window.location.href = base_url+'Admin/A_cmdb_networkType_EditDetails/'+id;
	}
    ...
    function delUser(id)
    {
        ...
        $("#confirm").click(function (){
            var other_id = id;
            var nama_table = 'network_type';
            var where_column = 'other_id';

		...
		<section class="content">
			<div class="row">
				...
				<div class="" style="padding-bottom: 30px;align:right;">
					<legend><h3>PREVENTIVE MAINTENANCE PLAN<br>( UPS )</h3></legend>
				</div>
				...
				<div class="col-md-12">
					...
					<table>
						<tbody>
							<tr>
								<td style="width:600px;">Output Load : <?= $data->ups_1 ?></td>
								<td style="width:600px;">&nbsp;</td>
							</tr>
							<tr>
								<td style="width:600px;">Battery Capacity : <?= $data->ups_2 ?></td>
								<td style="width:600px;">&nbsp;</td>
							</tr>
							<tr>
								<td style="width:600px;">Battery Temperature : <?= $data->ups_3 ?></td>
								<td style="width:600px;">&nbsp;</td>
							</tr>
							<tr>
								<td style="width:600px;">Run Time Remaining : <?= $data->ups_4 ?></td>
								<td style="width:600px;">&nbsp;</td>
							</tr>
							<tr>
								<td style="width:600px;">Able to manage unit through console part : <?= $data->ups_5 ?></td>
								<td style="width:600px;">&nbsp;</td>
							</tr>
						</tbody>
					</table>

		...
		<section class="content">
			<div class="row">
				...
				<div class="" style="padding-bottom: 30px;align:right;">
					<legend><h3>PREVENTIVE MAINTENANCE PLAN<br>( Firewall )</h3></legend>
				</div>
				...
				<div class="col-md-12">
					...
					<table>
						<tbody>
							<tr>
								<td style="width:600px;">Able to manage firewall through : <?= $data->firewall_1 ?></td>
								<td style="width:600px;">&nbsp;</td>
							</tr>
							<tr>
								<td style="width:600px;">Able to manage unit through console part : <?= $data->firewall_2 ?></td>
								<td style="width:600px;">&nbsp;</td>
							</tr>
							<tr>
								<td style="width:600px;">Connection Usage : <?= $data->firewall_3 ?></td>
								<td style="width:600px;">&nbsp;</td>
							</tr>
							<tr>
								<td style="width:600px;">System Uptime : <?= $data->firewall_4 ?></td>
								<td style="width:600px;">&nbsp;</td>
							</tr>
							<tr>
								<td style="width:600px;">Check SNMP (string) : <?= $data->firewall_5 ?></td>
								<td style="width:600px;">&nbsp;</td>
							</tr>
							<tr>
								<td style="width:600px;">VPN Status : <?= $data->firewall_6 ?></td>
								<td style="width:600px;">&nbsp;</td>
							</tr>
							<tr>
								<td style="width:600px;">Connection : <?= $data->firewall_7 ?></td>
								<td style="width:600px;">&nbsp;</td>
							</tr>
							<tr>
								<td style="width:600px;">Peak : <?= $data->firewall_8 ?></td>
								<td style="width:600px;">&nbsp;</td>
							</tr>
							<tr>
								<td style="width:600px;">Current : <?= $data->firewall_9 ?></td>
								<td style="width:600px;">&nbsp;</td>
							</tr>
							<tr>
								<td style="width:600px;">Max : <?= $data->firewall_10 ?></td>
								<td style="width:600px;">&nbsp;</td>
							</tr>
							<tr>
								<td style="width:600px;">Nodes / user : <?= $data->firewall_11 ?></td>
								<td style="width:600px;">&nbsp;</td>
							</tr>
							<tr>
								<td style="width:600px;">SSL VPN Nodes / User : <?= $data->firewall_12 ?></td>
								<td style="width:600px;">&nbsp;</td>
							</tr>
							<tr>
								<td style="width:600px;">VPN : <?= $data->firewall_13 ?></td>
								<td style="width:600px;">&nbsp;</td>
							</tr>
							<tr>
								<td style="width:600px;">Global VPN Client : <?= $data->firewall_14 ?></td>
								<td style="width:600px;">&nbsp;</td>
							</tr>
							<tr>
								<td style="width:600px;">CFP (Content Filter) : <?= $data->firewall_15 ?></td>
								<td style="width:600px;">&nbsp;</td>
							</tr>
							<tr>
								<td style="width:600px;">Gateway Anti Virus : <?= $data->firewall_16 ?></td>
								<td style="width:600px;">&nbsp;</td>
							</tr>
							<tr>
								<td style="width:600px;">Anti-Spyware : <?= $data->firewall_17 ?></td>
								<td style="width:600px;">&nbsp;</td>
							</tr>
							<tr>
								<td style="width:600px;">Instrusion Prevention : <?= $data->firewall_18 ?></td>
								<td style="width:600px;">&nbsp;</td>
							</tr>
							<tr>
								<td style="width:600px;">App Control : <?= $data->firewall_19 ?></td>
								<td style="width:600px;">&nbsp;</td>
							</tr>
							<tr>
								<td style="width:600px;">App Visualization : <?= $data->firewall_20 ?></td>
								<td style="width:600px;">&nbsp;</td>
							</tr>
							<tr>
								<td style="width:600px;">WXAC Acceleration : <?= $data->firewall_21 ?></td>
								<td style="width:600px;">&nbsp;</td>
							</tr>
							<tr>
								<td style="width:600px;">Botnet : <?= $data->firewall_22 ?></td>
								<td style="width:600px;">&nbsp;</td>
							</tr>
						</tbody>
					</table>

		...
		<section class="content">
			<div class="row">
				...
				<div class="" style="padding-bottom: 30px;align:right;">
					<legend><h3>PREVENTIVE MAINTENANCE PLAN<br>( Load Balance )</h3></legend>
				</div>
				...
				<div class="col-md-12">
					...
					<table>
						<tbody>
							<tr>
								<td style="width:600px;">Check system logs : <?= $data->load_balance_1 ?></td>
								<td style="width:600px;">&nbsp;</td>
							</tr>
							<tr>
								<td style="width:600px;">Hard Disk Usage : <?= $data->load_balance_2 ?></td>
								<td style="width:600px;">&nbsp;</td>
							</tr>
							<tr>
								<td style="width:600px;">Check System Memory : <?= $data->load_balance_3 ?></td>
								<td style="width:600px;">&nbsp;</td>
							</tr>
						</tbody>
					</table>

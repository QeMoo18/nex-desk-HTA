				...
				<td>
					  ...
					  <tr>
					  	<td style="width: 80%" class="">
					    	<span class="font_12">
					    		&nbsp;&nbsp;&nbsp;
					    		a. (Memory Utilization : _________)
					    	</span>
					    </td>
					    <td style="width: 10%">
					    	<span class="font_12">
			  		...
			  		<table style="width:100%">
						...
						<tr>
						  	<td style="width: 80%" class="">
						    	<span class="font_12">
						    		&nbsp;&nbsp;&nbsp;
						    		a. (Unique Firewall Identifier : ________)
						    	</span>
						    </td>
						    <td style="width: 10%">
						    	<span class="font_12">
			  	...
			  	<td>
			  		<table style="width:100%">
						...
						<tr>
						  	<td style="width: 80%" class="">
						    	<span class="font_12">
						    		5. Replace Battery Indicator (_____)
						    	</span>
						    </td>
						    <td style="width: 10%">
						    	<span class="font_12">

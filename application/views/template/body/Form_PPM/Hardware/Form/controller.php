<div class="pageheader hidden-xs">
    <h3><i class="fa fa-list"></i> Form PPM : Controller </h3>
					...
					<div class="box box-success">
			          <div class="box-header with-border">
			            <label class="box-title"> <b><?= get_name_activity(hex2bin($_GET['ppm_id']))?> : <?= hex2bin($_GET['hostname'])?></b> </label>
			          	...
			          	<form action="<?=base_url()?>Form_PPM/Add_Controller" method="post" id="form_data">
		    ...
		    $.ajax({
		                ...
		                success: function(response){
		                	if(response>0){
		                		...
		                		$('#form_data').attr('action', '<?= base_url()?>Form_PPM/Add_Controller');
		                		getDetails();
		                	}
		               	}
		          })
		    ...
		    $.ajax({
		                ...
		                success: function(response){
		                	if(response)
		                	{
		                		...
		                		detail();
								$('#form_data').attr('action', '<?= base_url()?>Form_PPM/Update_Controller');
		                	}
		               	}
		          })
		}

<div class="pageheader hidden-xs">
    <h3><i class="fa fa-list"></i> Form PPM : Access Point </h3>
					...
					<div class="box box-success">
			          <div class="box-header with-border">
			            <label class="box-title"> <b><?= get_name_activity($this->session->userdata('id_activity'))?> : <?= hex2bin($_GET['hostname'])?></b> </label>
			          	...
			          	<form action="<?=base_url()?>Form_PPM/Add_access_point" method="post" id="form_data">
		    ...
		    $.ajax({
		                ...
		                success: function(response){
		                	if(response)
		                	{
		                		...
		                		detail();
								$('#form_data').attr('action', '<?= base_url()?>Form_PPM/Update_Access_Point');
		                	}
		               	}
		          })
		}

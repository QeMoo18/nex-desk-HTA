    ...
    <h3><i class="fa fa-list"></i> List PPM : Computer </h3>
    		...
    		<div class="row">
                ...
                <div class="col-md-12" id="content-mobile" style="padding-top: 30px; padding-bottom: 30px; padding-left: 20px; padding-right: 20px;">
                    <select class="form-control" id="go_to_selected" onchange="go_to_selected();">
                        ...
                        <option value="Computer">Add Computer PPM</option>
                        <option value="Server">Add Server & Storage PPM</option>
                ...
                <script type="text/javascript">
                    function go_to_selected()
                    {
                        ...
                        if(go_to_selected=='Overview'){
                            window.location.href="<?= base_url()?>Form_PPM/List_Computer";
                        } else if(go_to_selected=='Computer'){
                            window.location.href="<?= base_url()?>Form_PPM/PPM_Form_Computer";
                        } else if(go_to_selected=='Server'){
                            window.location.href="<?= base_url()?>Form_PPM/PPM_Form_Server_Stroage";
                        } else if(go_to_selected=='Verified'){
                            window.location.href="<?= base_url()?>Form_PPM/List_Computer/Verified";
                        } else if(go_to_selected=='Endorse'){
                            window.location.href="<?= base_url()?>Form_PPM/List_Computer/Endorse";
                        } else {
                            window.location.href="<?= base_url()?>Form_PPM/List_Computer";
                        }
                    }
    			...
    			<div class="col-md-12">
    				...
    				<div class="box box-success">
    		          <div class="box-header with-border">
    		            <h3 class="box-title"> <b>List Computer PPM</b></h3>
    		          </div>
    		          <div class="box-body">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        if(type_selected=='List_Computer_Type'){
            var url = "<?=base_url()?>Form_PPM/Dtable_list_computer_only";
            
        } else if(type_selected=='List_Server_Type'){
            var url = "<?=base_url()?>Form_PPM/Dtable_list_server_only";
        } else {
            
            var url = "<?=base_url()?>Form_PPM/Dtable_list_computer";
        } 
...
<form action="<?=base_url()?>Form_PPM/PDF_Computer/<?= $this->uri->segment(4)?>" method="post" id="pdf_data">
...
<script type="text/javascript">
    $(document).ready(function (){
        ...
        $(".dataTables_filter").append('<select class="form-control" id="go_type" onchange="go_by_type();"><option value="0">-- Type --</option><option value="1">Computer & Notebook</option><option value="2">Server & Storage</option></selected>');
    ...
    function go_by_type()
    {
        ...
        if(go_type=='1'){
            window.location.href="<?= base_url()?>Form_PPM/List_Computer_Type/1";
        } else if(go_type=='2'){
            window.location.href="<?= base_url()?>Form_PPM/List_Server_Type/2";
        } else if(go_type=='0') {
            window.location.href="<?= base_url()?>Form_PPM/List_Computer/0";
        }
    }

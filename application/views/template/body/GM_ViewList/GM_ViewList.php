			...
			<div class="col-md-8">
				...
				<div class="box box-success">
		          <div class="box-header with-border">
		            <label class="box-title"> <b>List Group</b></label>
		          </div>
		          <div class="box-body">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        var t = $("#mytable2").dataTable({
            ...
            columns: [
                ...
                {"data": "Changed"},
                {"data": "Created"},
                {"data": "id_group",render:editIcon},
                {"data": "id_group",render:delIcon}
	...
	function editUser(id)
	{
		...
		window.location.href = base_url+'Admin/GM_EditDetails/'+id;
	}
    ...
    function delUser(id)
    {
        ...
        $("#confirm").click(function (){
            var other_id = id;
            deletenow_join(other_id);
        });

    }


    function deletenow_join(other_id)
    {

        var nama_table = 'group';
        var nama_table2 = 'role';
        var where_column = 'id_group';
        var where_column2 = 'name';
        ...
        var data =  {
                ...
                $.ajax({
                        url: '<?= base_url() ?>Admin/gm_delete_data_join',
                        type: 'POST',
                        dataType: 'html',
                        data: data,
                        beforeSend: function() {

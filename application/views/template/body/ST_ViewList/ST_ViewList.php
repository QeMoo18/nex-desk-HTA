	...
	<section class="content">
		...
		<div class="row">
			<div class="col-md-2">
				...
				<a href="<?=base_url()?>Admin/ST_AddServiceType"><button class="btn btn-success btn-block"> + Add Service Type</button></a>
				</div>
			</div>
			...
			<div class="col-md-7">
				...
				<div class="box box-success">
		          <div class="box-header with-border">
		            <h3 class="box-title"> <b>View Service Type</b></h3>
		          </div>
		          <div class="box-body">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        var t = $("#mytable2").dataTable({
            ...
            ajax: {
                      data: send_param,
                      "url": "<?=base_url()?>Admin/Dtable_ST_ViewList", 
                      "type": "POST"
                  },
            columns: [
                // {
                ...
                {"data": "changed"},
                {"data": "created"},
                {"data": "service_type_id",render:editIcon},
                {"data": "service_type_id",render:delIcon}
	...
	function editUser(id)
	{
		...
		window.location.href = base_url+'Admin/ST_EditDetails/'+id;
	}
    ...
    function delUser(id)
    {
        ...
        $("#confirm").click(function (){
            var other_id = id;
            var nama_table = 'service_type';
            var where_column = 'service_type_id';

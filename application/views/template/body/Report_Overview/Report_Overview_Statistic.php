...
<div class="content-wrapper">
	<section class="content">
		...
		<div class="row">
			...
			<div class="col-md-7">
                <form action="<?= base_url()?>Report/combine_report" method="POST">   
    				<div class="box box-success">
    		          <div class="box-header with-border">
    		            <h3 class="box-title"> <b>Report Overview Data & Visual</b></h3>
    		          </div>
    		          <div class="box-body">
                    ...
                    <!-- <div class="btn btn-primary btn-block" onclick="generate()"> Generate </div> -->
...
<script type="text/javascript">
	...
	function list_all_group(){
        ...
        var tick = function ( data, type, row ) {
                if ( type === 'display' ) {
                    // return '<center><input type="checkbox" value="'+data+'" class="IDReport" name="IDReport"></center> ';

                    return '<center><input type="checkbox" value="'+data+'" class="id_report" name="id_report[]"></center> ';
        ...
        var t = $("#mytable2").dataTable({
            ...
            ajax: {
                      data: send_param,
                      "url": "<?=base_url()?>Report/Dtable_List_Report_DataVisual", 
                      "type": "POST"
                  },
            columns: [
                // {
    ...
    function generate()
    {
        ...
        var data = 
                    ...
                    $.ajax({
                            url: '<?= base_url() ?>Report/combine_report',
                            type: 'POST',
                            dataType: 'html',
                            data: data,
                            beforeSend: function() {

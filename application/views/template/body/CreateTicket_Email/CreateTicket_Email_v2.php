...
<div class="content-wrapper">
	...
	<section class="content">
		<?= lookup_navbar(); ?> 
		<h5><i class="fa fa-angle-double-right" aria-hidden="true"></i> New Email Ticket </h5>
								...
								<div class="col-md-12">
					           	...
					           	<div class="col-md-12">
					                <div class="form-group col-md-6">
					                  ...
					                  <input type='email' class='form-control' name='tp_cc' id='tp_cc'> 
					                </div>
							
									<div class="form-group col-md-6">
					                  <label for="exampleInputEmail1">Bcc</label>
					                  <input type='email' class='form-control' name='tp_bcc' id='tp_bcc'> 
					                </div>
				            	</div>
						  ...
						  <div class="panel panel-danger">
						    ...
						    <div id="collapse2" class="panel-collapse collapse in">
						      <div class="panel-body">
								...
								<div class="col-md-12" id="btype_div">
									<div class="form-group col-md-6">

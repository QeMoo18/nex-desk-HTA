        ...
        <div class="row">
            <div class="col-md-2"> 
                <div class="form-group">
                    <a href="<?= base_url()?>admin/A_cmdb_hardware_add"> 
                        <button class="btn btn-danger btn-block"> + Add Hardware</button>
                    </a>
                </div>
            </div>
            <div class="col-md-10">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        var t = $("#mytable2").dataTable({
            ...
            ajax: {
                      data: send_param,
                      "url": "<?=base_url()?>Admin/Dtable_CMDB_Hardware_ViewList", //CREATE FUNCTION DEKAT CONTROLLER 
                      "type": "POST"
                  },
            columns: [
	...
	function editUser(id)
	{
		...
		window.location.href = base_url+'Admin/A_cmdb_hardware_EditDetails/'+id;
	}
    ...
    function delIcon(id)
    {
        ...
        $("#confirm").click(function (){
                ...
                $.ajax({
                            url: '<?= base_url() ?>Admin/Delete_CMDB_Hardware_ViewList', //create nama function delete controller
                            type: 'POST',
                            dataType: 'html',
                            data: data,
                            beforeSend: function() {

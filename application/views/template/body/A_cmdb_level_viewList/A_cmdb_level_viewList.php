	...
	<section class="content">
		...
		<div class="row">
			<div class="col-md-2">
				...
				<a href="<?=base_url()?>Admin/A_cmdb_level_add"><button class="btn btn-success btn-block"> + Add Level </button></a>
				</div>
			</div>
			<div class="col-md-7">
				...
				<div class="box box-success">
		          <div class="box-header with-border">
		            <h3 class="box-title"> <b>List Level</b></h3>
		          </div>
		          <div class="box-body">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        var t = $("#mytable2").dataTable({
            ...
            ajax: {
                      data: send_param,
                      "url": "<?=base_url()?>Admin/Dtable_Level", 
                      "type": "POST"
                  },
            columns: [
                // {
	...
	function editUser(id)
	{
		...
		window.location.href = base_url+'Admin/Fault_ITSM_EditView/'+id;
	}
    ...
    function delUser(id)
    {
        ...
        $("#modal_contain").html('Are you sure to delete ? We will delete all associated with this level ');

        $("#confirm").click(function (){
            var other_id = id;
            var nama_table = 'lookup_level';
            var where_column = 'id';
    ...
    function deletenow(other_id,nama_table,where_column)
    {
        var data =  {
                ...
                $.ajax({
                        url: '<?= base_url() ?>Admin/delete_data3',
                        type: 'POST',
                        dataType: 'html',
                        data: data,
                        beforeSend: function() {

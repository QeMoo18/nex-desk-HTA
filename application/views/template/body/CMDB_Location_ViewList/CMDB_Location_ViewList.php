	...
	<section class="content">
		...
		<div class="row">
			...
			<div class="col-md-2">
				...
				<a href="<?=base_url()?>CMDB/CMDB_Location_Add"><button class="btn btn-success btn-block"> + Add Location</button></a>
				</div>
			</div>
			<?php } ?>
			...
			<?php } ?>
				...
				<div class="box box-success">
		          <div class="box-header with-border">
		            <h3 class="box-title"> <b>View Location List</b></h3>
		          </div>
		          <div class="box-body">
...
<script type="text/javascript">
	...
	function search_network(){
        ...
        var t = $("#mytable2").dataTable({
            ...
            ajax: {
                      data: send_param,
                      "url": "<?=base_url()?>CMDB/Dtable_CMDB_Location_ViewList", 
                      "type": "POST"
                  },
            columns: [
	...
	function edit(id)
	{
		...
		window.location.href = base_url+'CMDB/CMDB_Location_EditDetails/'+id;
	}

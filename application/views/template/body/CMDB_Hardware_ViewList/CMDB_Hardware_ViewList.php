	...
	<section class="content">
		...
		<div class="row">
			...
			<div class="col-md-2">
				...
				<a href="<?=base_url()?>CMDB/CMDB_Hardware_Add"><button class="btn btn-success btn-block"> + Add Hardware</button></a>
				</div>
			</div>
			<?php } ?>
...
<script type="text/javascript">
	...
	function search_computer(){
        ...
        var t = $("#mytable2").dataTable({
            ...
            ajax: {
                      data: send_param,
                      "url": "<?=base_url()?>CMDB/Dtable_CMDB_Hardware_ViewList", 
                      "type": "POST"
                  },
            columns: [
	...
	function edit(id)
	{
		...
		window.location.href = base_url+'CMDB/CMDB_Hardware_EditDetails/'+id;
	}

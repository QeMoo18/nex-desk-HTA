	...
	<section class="content">
		...
		<div class="row">
			<div class="col-md-2">
				...
				<a href="<?=base_url()?>Admin/View_notice_schedule"><button class="btn btn-success btn-block"> Go To Overview</button></a>
				</div>
			</div>
			<div class="col-md-7">
				...
				<div class="box box-success">
		          ...
		          <div class="box-body">
			                ...
			                <div class="form-group">
			                  <label for="exampleInputEmail1">Date Schedule</label>
			                  <input type='text' class='form-control datepicker' name='date_schedule' id="date_schedule"> 
			                </div>
	...
	function submit()
	{
		...
		if((title=='')||(date_schedule=='')){
			...
			var data = 
	            ...
	            $.ajax({
	                    url: '<?= base_url() ?>Admin/SendNotice_Add_Schedule',
	                    type: 'POST',
	                    dataType: 'html',
	                    data: data,
	                    beforeSend: function() {
	                    ...
	                    success: function(response){
	                    	...
	                    	window.location.href="<?=base_url()?>Admin/View_notice_schedule";

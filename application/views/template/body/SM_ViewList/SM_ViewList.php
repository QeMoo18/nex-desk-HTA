	...
	<section class="content">
		...
		<div class="row">
			<div class="col-md-2">
				...
				<a href="<?=base_url()?>Admin/SM_AddService"><button class="btn btn-success btn-block"> + Add Service</button></a>
				</div>
			</div>
			<div class="col-md-10">
				...
				<div class="box box-success">
		          <div class="box-header with-border">
		            <h3 class="box-title"> <b>View Service</b></h3>
		          </div>
		          <div class="box-body">
	...
	$(document).ready(function() {
        ...
        var t = $("#mytable2").dataTable({
            ...
            columns: [
                ...
                {"data": "changed"},
                {"data": "created"},
                {"data": "service_generated_id",render:editIcon},
                {"data": "service_generated_id",render:delIcon}

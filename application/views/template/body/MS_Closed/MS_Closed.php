...
<div class="content-wrapper">
    <section class="content">
        ...
        <div class="row">   
            ...
            <form id="idForm" action="<?=base_url()?>ticket/ticket_closed_master" method="post" enctype="multipart/form-data">
                <div class="col-md-9">
                      ...
                      <div class="box-body">
                        ...
                        <div class="col-md-8">
                            <div class="form-group col-md-6">
                                ...
                                <?php $id = $this->uri->segment('3') ?>
                                <input type="text" name='Ticket_Closed_Responsible2' id='Ticket_Closed_Responsible2' value="<?= pull_data_Responsibilty_master($id) ?>" class="form-control" disabled="disabled">
                                <input type="hidden" name='Ticket_Closed_Responsible' id='Ticket_Closed_Responsible' value="<?= pull_data_Responsibilty_master($id) ?>">
                                <span id="alert_tp_r"></span>
                            </div>
                    
                            <div class="form-group  col-md-6">
                              <label for="exampleInputEmail1">Provider Reference</label>
                              <input type='text' class='form-control' name='Ticket_Closed_TT_No2' id='Ticket_Closed_TT_No2' value="<?=  pull_data_provider_ref_master($id) ?>" disabled="disabled"> 
                              <input type='hidden' class='form-control' name='Ticket_Closed_TT_No' id='Ticket_Closed_TT_No' value="<?=  pull_data_provider_ref_master($id) ?>"> 
                            </div>

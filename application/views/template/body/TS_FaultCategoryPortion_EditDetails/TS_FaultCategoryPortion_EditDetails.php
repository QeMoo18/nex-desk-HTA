...
function details()
{
    ...
    $.ajax({
                url: '<?= base_url() ?>Admin/TS_FaultCategoryPortion_details',
                type: 'POST',
                dataType: 'json',
                data: data,
                beforeSend: function() {
                ...
                success: function(response){
					...
					var default_name = $("#FCP_name").val(response.name);
					var default_validity = $("#FCP_validity").val(response.validity);
                }
          });
}
...
function submit()
{
	...
	if(FCP_name==''){
		...
		$.ajax({
		            url: "<?= base_url() ?>Admin/TS_FaultCategoryPortion_update",
		            type: "POST",
		            dataType: "html",
		            data: data,
		            beforeSend: function() {
		            ...
		            success: function(response){
		            	//alert('Success Update Fault Category Portion');
		            	//location.reload();
